...
#define LBTESTBED_HASH_ENTRIES		(1024*1024*4)
#else
/* 32-bit has less address-space for hugepage memory, limit to 1M entries */
#define LBTESTBED_HASH_ENTRIES		(1024*1024*1)
#endif
...
/* Return ipv4 fwd lookup struct for EM. */
void *
em_get_ipv4_lbtestbed_lookup_struct(const int socketid);

#endif  /* __LB_TESTBED_H__ */
